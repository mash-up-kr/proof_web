...
const LeftBar = styled.div<{isActive: boolean, rate: number}>`
  ...
  background: ${({isActive}) => isActive ? 'linear-gradient(270deg, #96B602 0%, rgba(186, 227, 72, 0) 100%)' : 'none'};
...
const RightBar = styled.div<{isActive: boolean, rate: number}>`
  ...
  background: ${({isActive}) => isActive ? 'linear-gradient(90deg, #6748E3 0%, rgba(103, 72, 227, 0) 100%)' : 'none'};
